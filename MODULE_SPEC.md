...
| `site:check` | CI-grade content check on a built `site/`: broken internal links/images, missing alt text, orphaned pages |
...
- CI-grade content quality gate (broken internal links/images, missing alt text, orphaned pages) — **done**, see section 2's verb table (`site:check`) and `docs/cli-reference.md`
