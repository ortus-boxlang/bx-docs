...
Bestehen/Durchfallen-Gate (das ist die Aufgabe von `site:check`).
...
bereits löst (`site:check`), hier angewendet auf rohen Markdown-Quelltext zur
...
Build, getrennt von `site:check` (das nur eine bereits gebaute `site/`
untersucht). Prüft:
